...
#                                                     TASK 4
#   Write a script that allows the user to search for specific lines in a server access log according to a pattern
#   they provide and have these lines written to a new file for further use.
